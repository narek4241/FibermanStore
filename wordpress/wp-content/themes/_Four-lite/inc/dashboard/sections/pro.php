		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p><?php esc_html_e( 'Setup your static front page with content sections like in the demo.', 'thefour-lite' ); ?></p>
				</td>
				<td><span class="dashicons dashicons-yes"></span></td>
				<td><span class="dashicons dashicons-yes"></span></td>
			</tr>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<a href="<?php echo esc_url( "https://gretathemes.com/wordpress-themes/thefour/?utm_source=theme_dashboard&utm_medium=buy_link&utm_campaign={$this->theme->template}_dashboard" ); ?>" target="_blank" class="button button-primary button-hero"><?php esc_html_e( 'Get TheFour PRO now', 'thefour-lite' ); ?></a>
				</td>
			</tr>
		</tbody>
	</table>
